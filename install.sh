...
wget -q --retry-connrefused --tries=0 https://raw.githubusercontent.com/re-DWORD/mobox_customization/main/termux-style/termux-style-custom -P $PREFIX/glibc/opt/termux-style
...
wget -q --retry-connrefused --tries=0 https://raw.githubusercontent.com/re-DWORD/mobox_customization/main/scripts/custom-dynarec-settings -P $PREFIX/glibc/opt/scripts
wget -q --retry-connrefused --tries=0 https://raw.githubusercontent.com/re-DWORD/mobox_customization/main/scripts/custom-mobox -P $PREFIX/glibc/opt/scripts
wget -q --retry-connrefused --tries=0 https://raw.githubusercontent.com/re-DWORD/mobox_customization/main/scripts/custom-settings -P $PREFIX/glibc/opt/scripts
